  ...
  data () {
    return {
      ...
      pointlist: [{
        ...
        lon: 430.5,
        lat: 468.5,
        imgUrl: require('@/assets/img/radioin.png'),
        inOrout: 1,
        iconWidth: 40,
        iconHeight: 47,
        typeId: 'radio',
        ...
        imgUrl: require('@/assets/img/radioout.png'),
        inOrout: 0,
        iconWidth: 40,
        iconHeight: 47,
        typeId: 'radio',
...
.radio >>> .el-pagination.is-background.el-pagination--small .el-pager li {
  margin: 0 .06rem;
  min-width: .44rem;
}
.radio >>> .el-pagination--small .el-pager li, .el-pagination--small .el-pager li.btn-quicknext {
  font-size: .24rem;
  line-height: .44rem;
  height: .44rem;
}
...
.radio >>> .el-pagination .btn-next .el-icon, .el-pagination .btn-prev .el-icon {
  font-size: .24rem;
}
.radio >>> .el-pagination.is-background .btn-next, .el-pagination.is-background .btn-prev, .el-pagination.is-background .el-pager li {
  background-color: rgba(6,50,32,1);
  color: rgba(255,255,255,.7);
}
.radio >>> .el-pagination.is-background .el-pager li {
  background-color: rgba(6,50,32,1);
  color: rgba(255,255,255,.7);
}
.radio >>> .el-pagination.is-background .btn-prev { 
  background-color: rgba(6,50,32,1);
  color: rgba(255,255,255,.7);
}
.radio >>> .el-pagination.is-background .el-pager li:not(.disabled).active {
